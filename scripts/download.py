...
This is the full-precision model (~62GB), downloaded once and then quantized to
int4 group-128 by quantize.py.

Usage:
    python scripts/download.py --repo_id Qwen/Qwen3-32B
    # gated/private repo:
    python scripts/download.py --repo_id Qwen/Qwen3-32B --hf_token hf_xxx
"""
