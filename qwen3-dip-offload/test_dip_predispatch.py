"""
test_dip_predispatch.py — DIP with modules swapped BEFORE accelerate dispatch.
This is the fix for the offload-hook binding problem.

Usage:
    python test_dip_predispatch.py --ckpt checkpoints/qwen3-32b-int4 \
        --gpu_mem 10 --tokens 8 --keep 0.32
"""
import argparse, time
import torch
from dip_linear import load_quantized_qwen3_dip, _use_gather
...
def main():
    ...
    model, tok, ctxs = load_quantized_qwen3_dip(
